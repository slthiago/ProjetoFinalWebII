...
<html>
    <div style="background: blue;" lass="pat" >
        <div> <a href = "http://localhost/aulas/estacionamento/index.php/controlador/incluir" style="color:#00FF00" class="pat" class="opp"> Home  </a>;</div>
    </div>
